...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Count how many neighbors are already known to be mines
        known_mine_count = 0
        ...
        # Create a new sentence if there are undetermined neighbors
        ...
        # 4 & 5) Keep inferring until no new information can be found
        changed = True
        while changed:
            changed = False
            
            # Check all sentences for known mines and safes
            for sentence in self.knowledge:
            ...
            # If sentence1 is a subset of sentence2, we can infer a new sentence
            new_sentences = []
    ...
    def make_safe_move(self):
        ...
        """
        # Find a safe cell that hasn't been played yet
    ...
    def make_random_move(self):
        ...
        for i in range(self.height):
            for j in range(self.width):
                cell = (i, j)
                # Only include cells that haven't been played and aren't mines
