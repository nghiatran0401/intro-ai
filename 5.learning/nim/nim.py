...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        # Look up Q-value in dictionary, return 0 if not found
    ...
    def best_future_reward(self, state):
        ...
        # Use get_q_value which returns 0 if Q-value doesn't exist
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # If epsilon is False, always choose the best action (greedy)
        if not epsilon:
        ...
        # With probability self.epsilon, choose random action
